...
success:function(data)
{
  ...
  ?>
      ...
      <i class="glyphicon glyphicon-plus"></i> Add Student</button></h1>
...
<div class="form-group">
  <label class="col-xs-4 control-label" for="lrn">Admission Number</label>  
  <div class="col-xs-6">
  <input id="lrn" name="lrn" type="text" placeholder="Enter Admission #" maxlength="12" class="form-control input-xs" required="">
  </div>
</div>
...
<div class="form-group">
  <label class="col-xs-4 control-label" for="address">Place of Birth</label>
  <div class="col-xs-8">
    <div class="input-group">
      <input id="address" class="form-control"
      style="text-transform: capitalize;" name="bp" placeholder="Place of Birth"  type="text" required="">    </div>
  </div>
</div>
</div>
...
<div class="form-group">
  <label class="col-xs-5 control-label" for="pg">Parent or Guardian</label>
  <div class="col-xs-7">
    <div class="input-group">
...
<br><br>
<div class="form-group">
  <label class="col-xs-4 control-label" for="Prog">Mode of Study</label>
  <div class="col-xs-4">
    ...
    mysqli_close($conn);
      ...
      <input type="submit" class="btn btn-success " name="submitb" value="Add Student">
  ...
  <table id="students" class="table table-bordered table-condensed">
    <thead>
      <tr id="heads">
        <th style="width:10%;text-align:center">Adm. No.</th>
        <th style="width:30%;text-align:center">Name of Student</th>
        <th style="width:20%;text-align:center">Mode of Study</th>
    ...
    <button  type="submit" name="student_delete" style="text-align:center"   class="btn btn-danger"  
     onclick="confirm('ARE YOU SURE YOU WANT THEM TO REMOVED FROM LIST?')" > Delete  
    </button>
    </form>
    </td>
