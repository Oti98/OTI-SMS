          ...
          <h3 class="page-header">Level <small>section</small></h3> 
      <?php
       ...
       <div class="col-md-8 " id="s_page">
        ...
        <div class="panel-heading">
          <h3 class="panel-title">List of Level</h3>
        </div> 
  ...
  function update_grade($i){
   var i = $i;
      ...
      <div class="row main">
        ...
        <h3 id="head">Add New Level</h3>
          <form class="" method="post">
            <input type="hidden" id="id" name="id">
            <div class="form-group">
              <label for="grade" class="cols-sm-2 control-label">Level</label>
              <div class="cols-sm-4">
