   ...
   $("#content").html(data);
       ...
       <div class="panel panel-default">
        <div class="panel-heading">
          <h3 class="panel-title">List of Mode of Study</h3>
        </div> 
  ...
  <table id="students" class="table table-hover table-bordered">
    ...
    <form method="post" action="update_program.php">
      ...
      <input type="hidden" name="id" value="<?php echo $row['PROGRAM_ID'] ?>">
        ...
        <td><center><a  data-toggle="modal" data-target="#program" data-id="<?php echo $row['PROGRAM'] ?>" id="get_sub">Courses</a>|<button type="submit" style="border:0px;background:white" ><i class="fa fa-pencil-square" aria-hidden="true"></i> update</button></center></td>
      </tr>
      </form>
      <?php
    } mysqli_close($conn);
      ...
      <div class="row main">
        ...
        <h3>Add Mode of study</h3>
          <form class="" method="post" >
            <input type="hidden" name="id">
            <div class="form-group">
              <label for="sub" class="cols-sm-2 control-label">Mode of Study</label>
              <div class="cols-sm-4">
                <div class="input-group">
                  <input type="text" class="form-control" name="cur" id="sub"
                  style="width:225px"  placeholder="Enter Mode of Study" value="<?php if(isset($_POST['cur'])){echo $_POST['cur'];} ?>"/>
                  <p>
