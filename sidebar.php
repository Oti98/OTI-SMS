...
<li>
    <a href="rms.php?page=notice "><i class="fa fa-users"></i> Notice</a>
</li>
<li>
...
<ul id="masterlistCollapse" class="collapse">
    ...
    <li class="">
        <a href="rms.php?page=program"><i class="fa fa-fw fa-bars"></i> Mode of Study List</a>
    </li>
</ul>
</li>
<li>
...
<li>
    ...
    <ul id="reportsCollapse" class="collapse">
        <li>
            <a href="rms.php?page=report"><i class="fa fa-fw fa-files-o"></i> Report Sheet</a>
        </li>
        <li>
...
<li>
    ...
    <ul id="maintenanceCollapse" class="collapse">
        ...
        <li>
            <a href="rms.php?page=grade"><i class="fa fa-fw fa-file-text-o"></i> Level List</a>
        </li>
    </ul>
</li>
