...
<head>
    ...
    <title>OTI COLLEGE OF EDUCATION</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header" style="background-color:  #ff6600">
                ...
                <a class="navbar-brand" href=""><b>&nbsp;&nbsp;&nbsp; <img src="474-4743252_school-logo-the-school-logo-ideas-step-to-success-school-removebg-preview[1].png" alt="..." width="5%">OTI COLLEGE Student Portal</b></a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav" style="background-color:  #4169e1">
                <li class="dropdown">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse"  style="background-color:  #4169e1">
            <?php 
            include 'db.php';
...
$page = $_GET['page'];
$pages = array('home','home2','notice_staffsend','sidebar_students','personal_details','notice_students', 
'notice','Students', 'subjects','student_p','records','record','addrecord','report','program',
'statistical','form137','list_report','student_report','users','school_year','grade','advisers',
'database','candidates','candidates_list', 'candidates_report','logs','register');
