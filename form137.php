...
<div style="margin-left:.5in;margin-right:.5in;margin-top:.1in;margin-bottom:.1in;line-height:1mm;">
		...
		<p><center><h4><b>OTI COLLEGE OF EDUCATION</b></h4></center></p>

		  </div>
		  <div class="row">
		  <div class="col-md-12">
		  <center><p><b> Students Report Sheet </b></p></center>
		  </div>
          </div>
          <div class="row">
		  <div class="col-md-12">
		...
		<tr>
		<td style="width:150px;border:1px solid black;font-size:12px;"><center><b>Course</b></center></td>
