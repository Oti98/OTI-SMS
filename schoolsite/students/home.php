		...
		<div class="sidebar-menu">
			...
			<div class="menu">
				<ul id="menu">
					...
					<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>View Notice</span></a></li>
					<li><a href="index.php"><i class="fa fa-tachometer"></i> <span>Visit School Site</span></a></li>
