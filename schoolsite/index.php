...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1 > <a class="navbar-brand" href="index.php"> Oti coe</a></h1> 
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="E91gAjunqOM" id="video"> <img src="images/otibanner2.png" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="container">
		...
		<div class="col-md-7 wthree-services-bottom-grids">
			...
			<div class="wthree-services-right">
				<img src="images/ab2.jpeg" alt="">
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="col-md-5 wthree-about-grids">
			 <h4>Welcome           to <br>Oti COE</h4> 
		...
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g1.jpg" class="swipebox"><img src="images/gg5.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OTI COE</h4>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g2.jpg" class="swipebox"><img src="images/gg6.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OTI COE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g3.jpg" class="swipebox"><img src="images/gg7.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OTI COE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g7.jpg" class="swipebox"><img src="images/gg3.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OTI COE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g5.jpg" class="swipebox"><img src="images/g1.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OTI COE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g6.jpg" class="swipebox"><img src="images/g2.jpeg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OTI COE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/g4.jpg" class="swipebox"><img src="images/gg8.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>OTI COE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/tt3.jpeg" alt="">
				  <h5>Oti Antwi</h5>
				  <div class="about_opa">
					<p>Professor</p>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/tt1.jpeg" alt="">
				  <h5>Markwo Benjamin</h5>
				  <div class="about_opa">
					<p>Senior Lecturer</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/tt4.jpeg" alt="">
				  <h5>Edu Ernest</h5>
				  <div class="about_opa">
					<p>Lecturer</p>
					<ul class="fb_icons2 text-center">
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/tt5.jpeg" alt="">
				  <h5>Owusu Bismark</h5>
				  <div class="about_opa">
					<p>Professor</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/tt2.jpeg" alt="">
				  <h5>Sampson Oti</h5>
				  <div class="about_opa">
					<p>Senior Lecturer</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/tt00.jpg" alt="">
				  <h5>Aduni Robert Abuga</h5>
				  <div class="about_opa">
					<p>Lecturer</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
		...
		<div class="agile_banner_bottom_grids">
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p> 0248084344 <span><?php echo  '0547713717'; ?></span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>©  2023 Oti College of Education. All rights reserved | Designed and Developed By Oti Antwi</p>
	</div>
</div>
	<?php } 
	else{ ?>
	...
	<div class="container">
		...
		<div class="agile_banner_bottom_grids">
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agilew3_contact">
					<h4>Address</h4>
					<p><?php echo "P O BOX 024, OTI COE "; ?></p>
			...
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p><?php echo " 0248084344"; ?> <span><?php echo "0547740621"; ?></span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				<div class="agile_contact_grid_left agileits_w3layouts_left1">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com"><?php echo "oticollegeofeducation@gmail.com"; ?></a>
						<span><a href="mailto:info@example.com"><?php echo "otiantwi@gmail.com"; ?></a></span></p>
				</div>
				<div class="clearfix"> </div>
			</div>
			<div class="clearfix"> </div>
...
<div class="footer">
	<div class="container">
		<div class="wthree_footer_grid_left">
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>About Us</h4> 
				<p><?php echo "OTI COE is an institution aimed at producing quality teachers across the globe"; ?></p>
			</div>
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				<h4>Navigation</h4>
				<ul>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo "oticollegeofedu@gmail.com"; ?></a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i><?php echo " 0248084344"; ?></li>
					<li><i class="fa fa-fax" aria-hidden="true"></i><?php echo "P O box 024, Kintampo, B-E"; ?></li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>©  <?php echo " OTI COLLEGE OF EDUCATION"; ?> - 2023. All rights reserved | Designed and Developed By Oti Antwi</p>
	</div>
</div>
	<?php }?>
	<!-- //footer --> 
...
<!-- Map-JavaScript -->
			...
			<script type="text/javascript">
				...
				function init() {
					var mapOptions = {
						zoom: 11,
						center: new google.maps.LatLng( 8.05627, -1.73058),
					...
					var marker = new google.maps.Marker({
						position: new google.maps.LatLng( 8.05627 -1.73058),
						map: map,
					});
				}
			</script>
